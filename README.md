...
| Michael | I found it relieving to finally present our planner project to others outside our class. We were able to receive input on whether the project was nice and practical, and let some individuals experiment with the project. It was also cool to later go around the school and tour classes who had creations that were very different from coding, but just as creative. Ceramics was super interesting, although everything had a set “goal” (skull or mug) there were no two students who created the same skull because they all had unique perspectives and personalities. I also saw some really talented students’ artworks that blew me away, I didn’t know high schoolers had the capabilities to draw like that. | [Journal](https://docs.google.com/document/d/1Kcb8k2XW2PODSQW_EKFYb1XKB39VrwB-OEAnCMM7Frs/edit#heading=h.rt3srcylhmev)|
| James | My work in this class was a unique experience that allowed me to learn about a new topic. I can use computing to help allow me to create websites for other classes. Also looking at the other classes were unique and that was different from what we did. The College board project helped us utilize tangibles and showcased what we learned this past trimester. I can prepare myself by allowing myself to use perspective and other websites along with coding to allow myself to create new websites that can be used in the future. I also liked the Night at the Museum walk around because we could see the creativity of other students and show the quality of our school. |   [Journal](https://docs.google.com/document/d/1Kcb8k2XW2PODSQW_EKFYb1XKB39VrwB-OEAnCMM7Frs/edit#heading=h.rt3srcylhmev) |
| Ethan | I liked looking at the different projects for each class. Each class had different uses or art and were very interesting. In particular, the art classes were very enticing, as the different ways people could express themselves resonated with me. I would consider pursuing that, although I would have to evaluate my artistic talent and abilities to make my thoughts images. Below are some images of the group presenting at the night of the museum, and some cool art works we saw on our tour. | [Journal](https://docs.google.com/document/d/1-AS5NcpL8dvRFaj1oww0tR8XM1lf20oFSDFuEdq7OxQ/edit) |
